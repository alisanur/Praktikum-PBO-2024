...
public class App {
        ...
        for (Mebel mebel : daftarMebel) {
            if (kelas.isInstance(mebel)) {
                System.out.printf("%-5d%-10s%-15s%-10d%-15d%-15s\n", mebel.getId(), mebel.getNama(),
                        (mebel instanceof Meja) ? ((Meja) mebel).getMaterial() : "-", mebel.getHarga(),
    ...
    switch (pilihan) {
        case 1:
            ...
            daftarMebel.add(new Meja(nama, material, harga, stok));
        ...
        case 2:
            ...
            stok = scanner.nextInt();
            daftarMebel.add(new Kursi(nama, material, harga, stok));
        ...
        case 3:
            ...
            stok = scanner.nextInt();
            daftarMebel.add(new Lemari(nama, material, harga, stok));
