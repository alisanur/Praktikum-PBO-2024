...
public class App implements PengelolaanData {
    ...
    private static final String FILE_NAME = "data_mebel.txt";
    ...
    public void simpanData() {
        try (ObjectOutputStream outputStream = new ObjectOutputStream(new FileOutputStream(FILE_NAME))) {
            outputStream.writeObject(daftarMebel);
    ...
    public void muatData() {
        try (ObjectInputStream inputStream = new ObjectInputStream(new FileInputStream(FILE_NAME))) {
            daftarMebel = (ArrayList<Mebel>) inputStream.readObject();
    ...
    public static void tanganiKesalahan(Exception e) {
